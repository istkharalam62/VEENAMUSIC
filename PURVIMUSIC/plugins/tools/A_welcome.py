...
from PURVIMUSIC.utils.PURVIMUSIC_ban import admin_filter
import os
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("PURVIMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('PURVIMUSIC/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('PURVIMUSIC/assets/font.ttf', size=60)
